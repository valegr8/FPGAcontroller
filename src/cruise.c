...
{
  int cruise_control_flag = 0;
  int gas_pedal_flag = 0;
  ...
  *green_leds = 0;
  ...
  while(1)
  {
    ...
    //blink = 1;
   //*(green_leds) = blink; /* Red LEDR[k] is set equal to SW[k] */
   // blink = 0;
   // OSTimeDlyHMSM(0,0,0, CONTROL_PERIOD);
    //*(green_leds) = *(switches); /* Red LEDR[k] is set equal to SW[k] */
   // OSTimeDlyHMSM(0,0,0, CONTROL_PERIOD);
 // }
}
...
void ControlTask(void* pdata)
{
  ...
  printf("[ControlTask] Task created!\n");
